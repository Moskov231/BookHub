...
class DashboardFragment : Fragment() {
    ...
    var ratingComparator = Comparator<Book>{ book1,book2->
       if(book1.bookRating.compareTo(book2.bookRating, true)==0){//if ratings are same
           book1.bookName.compareTo(book2.bookName,true)//sort according to name
           }else{
            ...
            val jsonObjectRequest = object : JsonObjectRequest(Request.Method.GET,url,null,Response.Listener {
                try {
                    ...
                    if (success) {
                        ...
                        Toast.makeText(activity as Context, "Unexpected error5",Toast.LENGTH_LONG).show()
                    }
